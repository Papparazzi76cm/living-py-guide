import heroImage from '@/assets/hero-asuncion.webp';
...
export default function HomePage() {
  ...
  return <Layout title="Servicios para tu vida en Paraguay" description="Encuentra ayuda para instalarte, vivir y emprender en Paraguay. Profesionales sin cuotas de alta.">
    <section className="container mx-auto px-4 py-10 sm:px-6">
      ...
      <div className="mt-10"><ServiceCatalog /></div><img src={heroImage} alt="Vista de Asunción, Paraguay" className="mt-12 h-48 w-full rounded-2xl object-cover sm:h-64" loading="lazy" width="1200" height="400"/><h2 className="mt-12 text-2xl font-bold">Explora por categoría</h2>
