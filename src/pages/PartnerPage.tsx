...
export default function PartnerPage() {
  return <Layout title="Ofrece tus servicios · Alta gratuita" description="Únete al marketplace de Living Paraguay sin cuotas. Modelo de comisión por servicios contratados.">
    <section className="container mx-auto max-w-4xl px-4 py-12">
      ...
      <Link to="/mi-cuenta" className="mt-8 inline-flex rounded-xl bg-primary px-6 py-4 font-semibold text-primary-foreground">Crear mi perfil gratuito</Link>
      <p className="mt-4 text-sm text-muted-foreground">Crea tu cuenta y completa tu perfil profesional. La publicación de tu perfil requiere revisión; no implica contratación ni garantiza clientes.</p>
      ...
      <div className="mt-10 rounded-2xl bg-muted p-6"><h2 className="text-xl font-semibold">Condiciones claras desde el principio</h2><p className="mt-3">Cada presupuesto deberá indicar el alcance, los gastos adicionales, las condiciones de cancelación y el precio total para el cliente. El profesional conocerá la comisión y su importe neto antes de aceptar.</p><p className="mt-3 text-muted-foreground">Gestiona tus servicios, recibe solicitudes y prepara presupuestos desde tu cuenta. El pago online todavía no está habilitado.</p></div>
    </section></Layout>;
}
